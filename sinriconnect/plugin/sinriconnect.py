...
from enigma import eActionMap, eServiceReference, iServiceInformation
...
#					resol = {"UHD":3, "HD":2, "SD":1}
					...
					for x in NextEvent[2]:
						...
						if found != None:
#							servicetype = eServiceReference(x).getData(0)
#							if servicetype == 25:
#								r = "HD"
#							elif servicetype == 31:
#								r = "UHD"
#							else:
#								r = "SD"
#							info = ServiceReference(x).info()
#							transponder_info = info.getInfoObject(eServiceReference(x), iServiceInformation.sTransponderData)
