...
from enigma import eListboxPythonMultiContent, eListbox, ePixmap, eLabel, eSize, ePoint, gFont, getDesktop, BT_SCALE, BT_KEEP_ASPECT_RATIO, BT_ALIGN_CENTER
...
class FlexibleMenu(GUIComponent):
	...
	def applySkin(self, desktop, parent):
		...
		if isHD():
			self.pagelabel.resize(eSize(1240, 20))
		else:
						...
						self.entries.update({
							elem[0]:{
								"active":(
									...
									MultiContentEntryText(pos=(x+40, y+160), size=(self.activeboxwidth, 34), font=0, text=(_("Match") if elem[0] == "today" else "")),
									MultiContentEntryText(pos=(x+120, y+160), size=(self.activeboxwidth, 34), font=0, text=(_("Today") if elem[0] == "today" else "")),
								),
								"u_active":(
									...
									MultiContentEntryText(pos=(x+40, y+150), size=(self.boxwidth, 34), font=0, text=(_("Match") if elem[0] == "today" else "")),
									MultiContentEntryText(pos=(x+120, y+150), size=(self.boxwidth, 34), font=0, text=(_("Today") if elem[0] == "today" else "")),
								),
						"page":page
					}
				})
						...
						self.entries.update({
							elem[0]:{
								"active":(
									MultiContentEntryPixmap(pos=(x, y), size=(self.activeboxwidth,self.activeboxheight), png=self.selPixmap, flags=BT_SCALE),
									MultiContentEntryPixmapAlphaTest(pos=(x, y), size=(self.activeboxwidth,self.activeboxheight), png=logo, flags=BT_SCALE|BT_ALIGN_CENTER|BT_KEEP_ASPECT_RATIO),
									MultiContentEntryText(pos=(x+50, y+168), size=(self.activeboxwidth, 34), font=0, text=(_("Match") if elem[0] == "today" else "")),
									MultiContentEntryText(pos=(x+170, y+168), size=(self.activeboxwidth, 34), font=0, text=(_("Today") if elem[0] == "today" else "")),
								),
								"u_active":(
									MultiContentEntryPixmap(pos=(x+xoffset, y+yoffset), size=(self.boxwidth,self.boxheight), png=self.itemPixmap, flags=BT_SCALE),
									MultiContentEntryPixmapAlphaTest(pos=(x+xoffset, y+yoffset), size=(self.boxwidth,self.boxheight), png=logo, flags=BT_SCALE|BT_ALIGN_CENTER|BT_KEEP_ASPECT_RATIO),
									MultiContentEntryText(pos=(x+53, y+160), size=(self.boxwidth, 34), font=0, text=(_("Match") if elem[0] == "today" else "")),
									MultiContentEntryText(pos=(x+170, y+160), size=(self.boxwidth, 34), font=0, text=(_("Today") if elem[0] == "today" else "")),
								),
						"page":page
					}
				})
