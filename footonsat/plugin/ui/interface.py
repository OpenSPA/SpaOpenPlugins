...
from Tools.Directories import resolveFilename, SCOPE_PLUGINS, fileExists, SCOPE_LANGUAGE
...
class FootOnSat(Screen):
	...
	def __init__(self, session, link, *args):
		...
		if isHD():
			skin = "assets/skin/HD/interface.xml"
		else:
		...
		if len(self.matches) > 0:
			...
			for i in range(0, len(self.matches)):
				...
				if isHD():
					...
					res.append(MultiContentEntryPixmapAlphaBlend(pos=(260, 42), size=(40, 30), png=loadPNG(flagTeam1)))
					res.append(MultiContentEntryPixmapAlphaBlend(pos=(750, 42), size=(40, 30), png=loadPNG(flagTeam2)))
					res.append(MultiContentEntryPixmapAlphaTest(pos=(65, 6), size=(190, 100), png=loadPNG(banner), flags=BT_SCALE))
					res.append(MultiContentEntryPixmapAlphaBlend(pos=(-20, 33), size=(70, 50), png=loadPNG(notif)))
					res.append(MultiContentEntryText(pos=(300, 40), size=(450, 46), font=0, color=16777215, color_sel=16777215, backcolor_sel=None, flags=RT_VALIGN_CENTER | RT_HALIGN_LEFT, text=str(match)))
					res.append(MultiContentEntryText(pos=(260, 80), size=(450, 36), font=0, color=16777215, color_sel=16777215, backcolor_sel=None, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text="Kick-off : " + str(match_date)))
					res.append(MultiContentEntryText(pos=(260, 5), size=(685, 26), font=0, color=16777215, color_sel=16777215, backcolor_sel=None, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER, text=str(compet)))
					gList.append(res)
					res = []
				else:
					res.append(MultiContentEntryText(pos=(0, 0), size=(0, 0), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER | RT_WRAP, text='', color=16753920, color_sel=15657130, border_width=3, border_color=806544))
			...
			for data in self.js['footonsat']:
				try:
					if data['related_to'] == self.match:
						...
						if isHD():
							res.append(MultiContentEntryText(pos=(0, 0), size=(0, 0), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER | RT_WRAP, text='', color=16753920, color_sel=15657130, border_width=3, border_color=806544))
							res.append(MultiContentEntryText(pos=(7, 2), size=(510, 40), font=0, color=16777215, color_sel=16777215, backcolor_sel=None, flags=RT_VALIGN_CENTER | RT_HALIGN_LEFT, text=str(data['channel'])))
							gList.append(res)
							res = []
						else:
							res.append(MultiContentEntryText(pos=(0, 0), size=(0, 0), font=0, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER | RT_WRAP, text='', color=16753920, color_sel=15657130, border_width=3, border_color=806544))
